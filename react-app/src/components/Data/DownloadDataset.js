                        ...
                        <section className={style.resource}>
                            ...
                            <div className={style.resourceInfo}>
                                <dl>
                                    ...
                                    <a className={style.link} href={`https://www.ebi.ac.uk/ena/browser/view/${data.accessions[0]}`} target="_blank">{data.accessions[0]}</a>
                                    <dd><a className={style.link}></a></dd>
                                </dl>
                            </div>
                        </section>
                        ...
                        <section className={style.resource}>
                            ...
                            <div className={style.resourceInfo}>
                                <dl>
                                    ...
                                    <a className={style.link} href={`https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=${data.accessions[1]}`} target="_blank">{data.accessions[1]}</a>
                                    <dd><a className={style.link} ></a></dd>
                                </dl>
                            </div>
                        </section>
