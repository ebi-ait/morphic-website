                  ...
                  <div className={style.col}>
                    <dl className={style.desc}>
                      ...
                      <dd className={style.descDesc}>
                        <p>
                          Suspendisse consectetur tincidunt enim, vel consectetur
                          felis viverra eu. Pellentesque habitant morbi tristique senectus et netus
                          et malesuada fames ac turpis egestas. Ut fermentum
                          tortor pharetra fermentum convallis. Sed pulvinar varius
                          est at ultricies. Maecenas consequat nulla finibus eros
                          facilisis malesuada.
                        </p>
                        <p>
                          Pellentesque habitant morbi
                          tristique senectus et netus et malesuada fames ac turpis
                          egestas. Ut fermentum tortor pharetra fermentum
                          convallis. Sed pulvinar varius est at ultricies.
                        </p>
                      </dd>
                    </dl>
                  </div>
